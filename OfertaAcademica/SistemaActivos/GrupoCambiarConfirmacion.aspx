<%@ Page Title="" Language="C#" MasterPageFile="~/MasterDistribucion.Master" AutoEventWireup="true" CodeBehind="GrupoCambiarConfirmacion.aspx.cs" Inherits="SistemaActivos.GrupoCambiarConfirmacion" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
    ...
    <h4 style="text-align:center;background-color:#303F9F;color:white;">
        <br> 
        Cambiar Grupo de Aula   -   Colegio Universitario de Cartago 
        <pre>
        </pre>
    </h4>
    <br>
