<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Profesor.aspx.cs" Inherits="SistemaActivos.Profesor" %>
...
<body>
    <form id="form1" runat="server">
	        ...
	        <label class="logo" style="color:#45e1fb"> <img style="width:80px;height:80px; background-color:antiquewhite; margin-bottom:10px; margin-top:20px; margin-right:10px" src="Imagenes/logo_cuc.png" />Profesor </label>
         ...
         <div class="container">
	    <h2 class="form-titulo">Cursos del Profesor</h2>
    </div>
                ...
                <ItemTemplate>
                    ...
                    <div class="my-2 mx-auto p-relative bg-white shadow-1 blue-hover" style="width: 360px; overflow: hidden; border-radius: 1px;">
                        ...
                        <h1 class="ff-serif font-weight-normal text-black card-heading mt-0 mb-1" style="line-height: 1.25;">
                            Nombre del Profesor: <%# DataBinder.Eval(Container.DataItem,"Profesor")%>
                        </h1>
                        ...
                        <p class="mb-1"> Materia:  <%# DataBinder.Eval(Container.DataItem,"Materia")%></p>
