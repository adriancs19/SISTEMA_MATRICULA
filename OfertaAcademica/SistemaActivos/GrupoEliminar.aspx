<%@ Page Title="" Language="C#" MasterPageFile="~/MasterDistribucion.Master" AutoEventWireup="true" CodeBehind="GrupoEliminar.aspx.cs" Inherits="SistemaActivos.GrupoEliminar" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
    ...
    <h4 style="text-align:center;background-color:#303F9F;color:white;">
        <br> 
         Eliminar grupos de aula   -   Colegio Universitario de Cartago 
        <pre>
        </pre>
    </h4>
    <br>
        ...
        <div class="container">
            <h2 class="form-titulo">ELIMINAR GRUPO DE AULA</h2>
            ...
            HeaderText="Asignar Aula" SortExpression="Asignar Aula" >
                        <ItemTemplate >
                            <asp:LinkButton runat="server" CommandName="update"><span style="color:green"  class="material-icons">delete</span></asp:LinkButton>
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
            </asp:GridView>
