<%@ Page Title="" Language="C#" MasterPageFile="~/MasterDistribucion.Master" AutoEventWireup="true" CodeBehind="Grupos.aspx.cs" Inherits="SistemaActivos.Grupos" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
    ...
    <h4 style="text-align:center;background-color:#303F9F;color:white;">
        <br> 
        Cargar grupos individuales    -   Colegio Universitario de Cartago 
        <pre>
        </pre>
    </h4>
    <br>
        ...
        <div class="container">
            <h2 class="form-titulo">CARGAR GRUPOS INDIVIDUALES SEGÚN DISPONIBILIDAD</h2>
